...
A Java-powered humming-to-MIDI workspace. Record or upload a melody, correct it in a piano roll, preview the result, and export a standard MIDI file. An optional AI assistant edits notes from plain-English instructions.
...
The model is instructed to explain changes in English. Proposals are validated, then shown for preview, apply, or discard. Missing credentials do not produce simulated AI responses. Invalid output, denied credentials, quota limits, and timeouts return English errors.
...
frontend/app/               English music editor and styles
